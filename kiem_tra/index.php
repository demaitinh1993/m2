    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                ...
                <a class="btn btn-success" href="add.php">Thêm sinh viên</a>
                        <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" action="search.php" method="post">
                            <div class="input-group">
                                <input name="search" type="text" class="form-control bg-light border-0 small"  aria-label="Search" aria-describedby="basic-addon2" style="left:925px; right: inherit">
                                <div class="input-group-append">
                                    <button class="btn btn-primary" type="submit" style="left:925px;">Tìm
                                    </button>
                                </div>
                            </div>
                        </form>
