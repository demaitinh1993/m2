                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    <a class="nav-link collapsed" href="../login.php">Login</a>
                                    <a class="nav-link collapsed" href="../register.php">Register</a>
                                    <a class="nav-link collapsed" href="../password.php">Forgot Password</a>
